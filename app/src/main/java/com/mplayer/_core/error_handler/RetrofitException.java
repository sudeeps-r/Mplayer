...
public class RetrofitException extends RuntimeException {
    public static RetrofitException httpError(String message, Response response, Retrofit retrofit) {

        return new RetrofitException(message, "", response, Kind.HTTP, null, retrofit);
    }
